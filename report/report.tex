...
$$r=0,1,\; \chi=0.2,\;\beta=3.6$$
	...
	\begin{figure}[H]
		\centering
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{no-intervention-1.pdf}\label{fig:a}}
		\hfil
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{no-intervention-bifurcation-1.png}\label{fig:b}}
		
		\medskip
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{no-intervention-2.pdf}\label{fig:c}}
		\hfil
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{no-intervention-bifurcation-2.png}\label{fig:d}}
		
		\medskip
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{no-intervention-stochastic.pdf}\label{fig:e}}
		\hfil
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{no-intervention-bifurcation-stochastic.png}\label{fig:f}}
...
در شکل ۱ به بررسی بازار تنظیم نشده می‌پردازیم؛ در این بازار که برای مدت ۴۰۰ قدم زمانی اجرا شده به نظر می‌اید برای مقادیر کم $\beta$ بازار وارد فاز آشوب نمی‌شود (ب و د) و شاید حتی بتوان گفت که پایدار است اما به محض آنکه کمی عدم قطعیت ($\sigma_L^2=\nicefrac{1}{400}$) حالت‌های پایدار، شروع به ناپایدار شدن می‌کند و خم پایدار تبدیل به ناحیه پایدار می‌شود (و) و در ادامه این نواحی به قدری پهن می‌شوند که دیگر نمی‌توان به آن‌ها پایدار گفت.
		...
		\begin{figure}[H]
		\centering
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against.pdf}\label{fig:a}}
		\hfil
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-stochastic.pdf}\label{fig:b}}
		
		\medskip
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-intervention.pdf}\label{fig:c}}
		\hfil
		\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-intervention-stochastic.pdf}\label{fig:d}}
...
\begin{figure}[H]
	\centering
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-bifurcation.png}\label{fig:a}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-bifurcation-stochastic.png}\label{fig:b}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-bifurcation-intervention.png}\label{fig:c}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-bifurcation-stochastic-intervention.png}\label{fig:d}}
...
\end{figure}
	...
	\begin{figure}[H]
	\centering
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-volatility.pdf}\label{fig:a}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-mispricing.pdf}\label{fig:b}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-absint.pdf}\label{fig:c}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-profit.pdf}\label{fig:d}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-fundweight.pdf}\label{fig:e}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{lean-against-fundpos.pdf}\label{fig:f}}
...
\begin{figure}[H]
	\centering
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental.pdf}\label{fig:a}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-stochastic.pdf}\label{fig:b}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-intervention.pdf}\label{fig:c}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-intervention-stochastic.pdf}\label{fig:d}}
...
\end{figure}
	...
	\begin{figure}[H]
	\centering
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-volatility.pdf}\label{fig:a}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-mispricing.pdf}\label{fig:b}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-absint.pdf}\label{fig:c}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-profit.pdf}\label{fig:d}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-fundweight.pdf}\label{fig:e}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{target-fundamental-fundpos.pdf}\label{fig:f}}
	\caption{تاثیر دخالت دولت در بازار}
	\label{fig:myfigure}
\end{figure}
شش سنجه تعریف شده در شکل ۶، اینجا نیز مورد بررسی قرار می‌گیرند تا صرفه و عملکرد استراتژی دولت را مورد بررسی قرار دهند. در قیاس با استراتژی قبلی دولت می‌توان گفت - از آنجا که تاثیرات مشابهی بین دو استراتژی داریم- چون پارامتر $m$ در حدود ده برابر $d$ مقیاس شده، پارامتر $d$ خیلی در کنترل موثرتر است(آ). از طرفی برخی مشکلات که در استراتژی اول بروز می‌داد اینجا بروز نمی‌دهد؛ مانند قیمت گذاری نادرست و حجم دخالت در بازار که در این استراتژی با افزایش پارامتر کنترل کاهش خواهد یافت(ب و ج). هم چنین چون دیگر استراتژی خلاف جهت بازار نیست، برای قانون گذار سود آور خواهد بود(د). از آنجا که بازار به قیمت بنیادی نزدیک می‌شود سودی در بنیادگرا بودن وجود نخواهد داشتو به همین دلیل تعداد آن‌ها کاهش خواهد داشت.
	...
	\begin{figure}[H]
	\centering
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{robust-belief-volatility.pdf}\label{fig:a}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{robust-belief-mispricing.pdf}\label{fig:b}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{robust-randtrade-volatility.pdf}\label{fig:c}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{robust-randtrade-mispricing.pdf}\label{fig:d}}
	
	\medskip
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{robust-fundcost-volatility.pdf}\label{fig:e}}
	\hfil
	\sidesubfloat[]{\includegraphics[width=0.4\textwidth]{robust-fundcost-mispricing.pdf}\label{fig:f}}
